...
paramfile = Dataset("summa_zParamTrial_variableDecayRate_scT1_4vegSc4.nc",'w',format='NETCDF3_CLASSIC') #create new paramtrail.nc file
...
#%% 
varcheck = Dataset ('summa_zParamTrial_variableDecayRate_scT1_4vegSc4.nc')
print varcheck.variables['summerLAI'][:]
print varcheck.variables['maxMassVegetation'][:]

#%% # local attributes file
local_atrbt = Dataset("summa_zLocalAttributes_sagehenCreekT1_4vegScT.nc",'w',format='NETCDF3_CLASSIC')
# define dimensions 
...
local_atrbt.close()
#%%
lacheck = Dataset('summa_zLocalAttributes_sagehenCreekT1_4vegScT.nc')
...
in_condi = Dataset("summa_zInitialCond_scT1_4vegScT.nc",'w',format='NETCDF3_CLASSIC')
...
in_condi.close()
#%%
iccheck = Dataset("summa_zInitialCond_scT1_4vegScT.nc")
